...
Alternative distribution channels outside Google Play and the APK modding ecosystem. Relevant because malware distribution increasingly uses third-party stores and sideloading.
...
Modified APKs (mods) distributed through forums and dedicated sites. Modded APKs are a malware distribution vector: trojans are injected into popular cracked apps.
